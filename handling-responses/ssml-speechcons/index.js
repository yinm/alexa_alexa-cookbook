// 1. Text strings
const speechOutput = "aha, this is a phrase with speechcons, well done.";
...
const handlers = {
  'LaunchRequest': function() {
    speechOutput = addSpeechconSSML(speechOutput);
...
// 3. Helper Function
function addSpeechconSSML(text) {
...
const speechcons = [
  "abracadabra","achoo","aha","ahem","ahoy","all righty","aloha",
